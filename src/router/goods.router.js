...
const { getCount, getCategorySale, getFavor, getTop10, getAmountList, getAddressSale, insertProducts, createProduct, patchProduct, deleteProduct, getProducy } = require('../controller/goods.controller')
